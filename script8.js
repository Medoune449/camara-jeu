...
let banderas = ["Planète Mercure.jpg", "Planète Neptune.jpg", "Planète Uranus.jpg", "Planète Saturne.jpg", "Planète Terre.jpg",
                "Planète Mars.jpg", "Planète Jupiter.jpg", "Planète Vénus.jpg", "Globe Terrestre.jpg", "Clé usb.jpg"];

//Enregistrement des options correct
let correcta = [1,2,0,1,0,2,1,0,1,2];
...
opciones.push(["Planète Terre", "Planète Mercure", "Planète Jupiter"]);//71
opciones.push(["Planète eau", "Le cercle", "Planète Neptune"]);//72
opciones.push(["Planète Uranus", "Le globe terrestre", "Le vent"]);//73
opciones.push(["Le disque", "Planète Saturne", "Planète Vénus"]);//74
opciones.push(["Planète Terre", "Afrique", "Eau"]);//75
opciones.push(["Planète Avril", "Planète feu", "Planète Mars"]);//76
opciones.push(["Planète sable", "Planète Jupiter", "La Bille"]);//77
opciones.push(["Planète Vénus", "Planète feu", "Le Soleil"]);//78
opciones.push(["L'Amérique", "Globe Terrestre", "La Lune"]);//79
opciones.push(["Chargeur", "Carte mémoire", "Clé usb"]);//80
...
function terminarJuego(){
    ...
    if(cantidadAcertadas==10) { 
                    alert("You are a genius, your score is : 80");//le score augmente de 10 à chaque niveau
                    
              let targetURL ="niveau9.html";//jouer le niveau suivant
              ...
              let targetURL ="niveau8.html";//rejouer le niveau 
               let newURL =document.createElement('a');
               newURL.href =targetURL;
               document.body.appendChild(newURL);
               newURL.click();             
