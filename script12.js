...
let banderas = ["L’eau.jpg", "Le soleil.jpg", "Le bois.jpg", "Le sel.jpg", "Le pétrole.jpg",
                "Gaz naturel.jpg", "Le charbon.jpg", "L’uranium.jpg", "Le fer.jpg", "La bauxite.jpg"];

//Enregistrement des options correct
let correcta = [2,1,0,0,2,1,1,0,2,1];
...
opciones.push(["Une goutte", "La mer", "L’eau"]);//111
opciones.push(["Planète feu", "Le soleil", "Le feu"]);//112
opciones.push(["Le bois", " Le bâton", "Le caoutchouc"]);//113
opciones.push(["Le sel", "Le sucre", "L'ammoniac"]);//114
opciones.push(["L'huile", "Le vin noir", "Le pétrole"]);//115
opciones.push(["La lumière", "Gaz naturel", "La puissance"]);//116
opciones.push(["Le noir", "Le charbon", "La pierre noire"]);//117
opciones.push(["L’uranium", "Le diamant vert", "La couleur verte"]);//118
opciones.push(["Le zinc", "Le marbre", "Le fer"]);//119
opciones.push(["Le sable", "La bauxite", "L’hélium"]);//120
...
function terminarJuego(){
    ...
    if(cantidadAcertadas==10) { 
                    alert("You are getting stronger and stronger , your score is : 120");//le score augmente de 10 à chaque niveau
                    
              let targetURL ="niveau13.html";//jouer le niveau suivant
              ...
              let targetURL ="niveau12.html";//rejouer le niveau 
               let newURL =document.createElement('a');
               newURL.href =targetURL;
               document.body.appendChild(newURL);
               newURL.click();             
