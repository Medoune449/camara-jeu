...
let banderas = ["The postman.jpg", "The sweeper.jpg", "The teacher.jpg", "Architect.jpg", "Artist.jpg",
                "Cameraman.jpg", "Computer programmer.jpg", "Dancer.jpg", "Fireman.jpg", "Historian.jpg"];

//Enregistrement des options correct
let correcta = [0,2,0,1,1,2,0,2,1,1];
...
opciones.push(["The postman", "The policeman", "The sweeper"]);//151
opciones.push(["The nurse", "The chef", "The sweeper"]);//152
opciones.push(["The teacher", "The doctor", "The judge"]);//153
opciones.push(["Adviser", "Architect", "Accountant"]);//154
opciones.push(["Chemist", "Artist", "Caterer"]);//155
opciones.push(["Bricklayer", "Coach", "Cameraman"]);//156
opciones.push(["Computer programmer", "Contractor", "Custom officer"]);//157
opciones.push(["Designer", "Developer", "Dancer"]);//158
opciones.push(["Florist", "Fireman", "Gardener"]);//159
opciones.push(["Hairdresser", "Historian", "Jeweller"]);//160
...
function terminarJuego(){
    ...
    if(cantidadAcertadas==10) { 
                    alert("Thank you Boss, your score is : 160");//le score augmente de 10 à chaque niveau
                    
              let targetURL ="niveau17.html";//jouer le niveau suivant
              ...
              let targetURL ="niveau16.html";//rejouer le niveau 
               let newURL =document.createElement('a');
               newURL.href =targetURL;
               document.body.appendChild(newURL);
               newURL.click();             
