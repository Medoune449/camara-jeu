...
let banderas = ["Carte mère.jpg", "Le processeur.jpg", "Le clavier.jpg", "L'écran pc.jpg", "Barrette ram.jpg",
                "Système windows.jpg", "Système mac.jpg", "Système linux.jpg", "bouton pc.jpg", "Cable coaxial.jpg"];

//Enregistrement des options correct
let correcta = [2,0,1,2,1,0,0,1,2,1];
...
opciones.push(["Batterie voiture", "L'ordinateur", "Carte mère"]);//81
opciones.push(["Le processeur", "Carte sim", "L'unité centrale"]);//82
opciones.push(["L'alphabet", "Le clavier", "La machine"]);//83
opciones.push(["Pile cmos", "La souris", "L'écran pc"]);//84
opciones.push(["Double décimètre", "Barrette ram", "Le mètre"]);//85
opciones.push(["Système windows", "Un logo", "Système mac"]);//86
opciones.push(["Système mac", "Système linux", "La pomme"]);//87
opciones.push(["Logo de la NASA", "Système linux", "Logo de Google"]);//88
opciones.push(["Bouton allumer", "Bouton éteindre", "Bouton allumer/éteindre"]);//89
opciones.push(["Cable à paire torsadée", "Cable coaxial", "Fibre optique"]);//90
...
function terminarJuego(){
    ...
    if(cantidadAcertadas==10) { 
                    alert("You are the best, your score is : 90");//le score augmente de 10 à chaque niveau
                    
              let targetURL ="niveau10.html";//jouer le niveau suivant
               ...
               newURL.click();
                   ...
                   alert("Ohh try again please !!!");
                   
              let targetURL ="niveau9.html";//rejouer le niveau 
               let newURL =document.createElement('a');
               newURL.href =targetURL;
               document.body.appendChild(newURL);
               newURL.click();             
