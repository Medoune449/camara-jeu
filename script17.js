...
let banderas = ["To bite.jpg", "To break.jpg", "To beat.jpg", "To bend.jpg", "To blow.jpg",
                "To catch.jpg", "To swing.jpg", "To sow.jpg", "To steal.jpg", "To win.jpg"];

//Enregistrement des options correct
let correcta = [2,0,2,1,0,1,2,0,1,2];
...
opciones.push(["To awake", "To bet", "To bite"]);//161
opciones.push(["To break", "To build", "To beat"]);//162
opciones.push(["To bend", "To burn", "To beat"]);//163
opciones.push(["To blow", "To bend", "To bleed"]);//164
opciones.push(["To blow", "To buy", "To bite"]);//165
opciones.push(["To choose", "To catch", "To swing"]);//166
opciones.push(["To swim", "To sow", "To swing"]);//167
opciones.push(["To sow", "To speed", "To speak"]);//168
opciones.push(["To sweat", "To steal", "To throw"]);//169
opciones.push(["To write", "To wet", "To win"]);//170
...
function terminarJuego(){
    ...
    if(cantidadAcertadas==10) { 
                    alert("Nice job, your score is : 170");//le score augmente de 10 à chaque niveau
                    
              let targetURL ="niveau18.html";//jouer le niveau suivant
              ...
              let targetURL ="niveau17.html";//rejouer le niveau 
               let newURL =document.createElement('a');
               newURL.href =targetURL;
               document.body.appendChild(newURL);
               newURL.click();             
