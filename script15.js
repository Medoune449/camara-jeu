...
let banderas = ["The wolf.jpg", "The fox.jpg", "The cougar.jpg", "The panda.jpg", "The cat.jpg",
                "The goldfish.jpg", "The jackal.jpg", "The raccoon.jpg", "The moose.jpg", "The turkey.jpg"];

//Enregistrement des options correct
let correcta = [1,0,2,1,0,2,1,0,2,2];
...
opciones.push(["The bear", "The wolf", "The cheetah"]);//141
opciones.push(["The fox", "The cougar", "The jaguar"]);//142
opciones.push(["The tiger", "The leopard", "The cougar"]);//143
opciones.push(["The rhino", "The panda", "The hippo"]);//144
opciones.push(["The cat", "The puppy", "The pet"]);//145
opciones.push(["The hamster", "The guinea pig", "The goldfish"]);//146
opciones.push(["The hyena", "The jackal", "The elk"]);//147
opciones.push(["The raccoon", "The moose", "The coyote"]);//148
opciones.push(["The giraffe", "The deer", "The moose"]);//149
opciones.push(["The duck", "The goose", "The turkey"]);//150
...
function terminarJuego(){
    ...
    if(cantidadAcertadas==10) { 
                    alert("Well done, your score is : 150");//le score augmente de 10 à chaque niveau
                    
              let targetURL ="niveau16.html";//jouer le niveau suivant
               ...
               newURL.click();
                   ...
                   alert("Oops, sorry for you !!!");
                   
              let targetURL ="niveau15.html";//rejouer le niveau 
               let newURL =document.createElement('a');
               newURL.href =targetURL;
               document.body.appendChild(newURL);
               newURL.click();             
